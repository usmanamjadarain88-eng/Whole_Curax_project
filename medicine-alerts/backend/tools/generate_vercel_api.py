...
SIMPLE = [
    ...
    ("admin_mobile_sign_in_start", {"POST": "admin_mobile_sign_in_start"}),
    ("admin_mobile_sign_in_verify", {"POST": "admin_mobile_sign_in_verify"}),
    ("admin_email_signup_start", {"POST": "admin_email_signup_start"}),
    ("admin_email_signup_verify", {"POST": "admin_email_signup_verify"}),
    ...
    ("signup_admins_directory", {"GET": "signup_list_admins_directory"}),
    ...
    ("maintenance_run_alert_checks", {"GET": "maintenance_run_alert_checks_cron", "POST": "maintenance_run_alert_checks"}),
    ...
    ("admin_send_user_message", {"POST": "admin_send_user_message"}),
    ("admin_pending_user_link_requests", {"GET": "admin_pending_user_link_requests"}),
    ("admin_accept_user_link_request", {"POST": "admin_accept_user_link_request"}),
    ("admin_reject_user_link_request", {"POST": "admin_reject_user_link_request"}),
    ("admin_set_user_display_mode", {"POST": "admin_set_user_display_mode"}),
    ...
    ("user_medicine_reminder_email", {"POST": "user_medicine_reminder_email"}),
    ...
    ("admin_delete_alerts", {"POST": "admin_delete_alerts"}),
...
def main() -> None:
    ...
    public_paths: dict[str, str] = {
        ...
        "admin_send_user_message": "/admin/send-user-message",
        ...
        "admin_delete_alerts": "/admin/delete-alerts",
