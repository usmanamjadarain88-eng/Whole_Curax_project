...
_STATIC: List[Tuple[str, str, str]] = [
    ...
    ("GET", "/maintenance/run-alert-checks", "maintenance_run_alert_checks_cron"),
    ...
    ("POST", "/admin/send-user-message", "admin_send_user_message"),
    ...
    ("POST", "/admin/delete-alerts", "admin_delete_alerts"),
...
_NAME_TO_FN = {
    ...
    "admin_delete_alerts": rh.admin_delete_alerts,
    ...
    "admin_send_user_message": rh.admin_send_user_message,
    ...
    "maintenance_run_alert_checks_cron": rh.maintenance_run_alert_checks_cron,
