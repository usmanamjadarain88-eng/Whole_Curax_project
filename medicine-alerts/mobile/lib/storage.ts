...
export interface StoredUser {
  ...
  pin_enabled: boolean;
  pin_code?: string;
  /** From desktop: links this app to the same backend so changes are detected on both */
  access_code?: string;
...
export interface AlertLog {
  ...
  status: LogStatus;
  source: LogSource;
  /** Which user this log belongs to (for admin main dashboard); optional for backward compat */
  userId?: string;
  userName?: string;
}
