...
interface LogsTableProps {
  logs: AlertLog[];
  onRefresh: () => void;
  /** Show "User" column (for main admin dashboard); default false */
  showUserColumn?: boolean;
}

export function LogsTable({ logs, onRefresh, showUserColumn = false }: LogsTableProps) {
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator style={styles.tableScroll}>
        <View style={styles.table}>
          <View style={[styles.row, styles.headerRow]}>
            ...
            {showUserColumn && (
              <Text style={[styles.cell, styles.headerCell, { width: nameWidth }]}>User</Text>
            )}
